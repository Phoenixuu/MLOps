...
class ZipDataIngestor(DataIngestor):
	def ingest(self, file_path: str) -> pd.DataFrame:
		...
		# Find the extracted CSV file (assuming there is one CSB file inside the zip)
...
class DataIngestorFactory:
	...
	def get_data_ingestor(file_extension: str) -> DataIngestor:
		"""Returns the appropriate DataIngestor based on file extentions."""
...
if __name__ == "__main__":
	...
	file_path = "D:/CODE AI/MLOps/data/archive.zip"
